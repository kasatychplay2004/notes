...
- [Лабораторная работа 3 - сегментация Ipv4](network-labs/segmentation) - Как проводить сегментация корпоративной сети
- [Лабораторная работа 4 - сети Wireshark](network-labs/wireshark-analysis/03-arp.md) - Проверка ARP-таблицы на признак спуфинга
